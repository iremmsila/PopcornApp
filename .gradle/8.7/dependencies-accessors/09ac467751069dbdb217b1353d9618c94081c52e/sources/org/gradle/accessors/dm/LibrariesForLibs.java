...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KotlinLibraryAccessors extends SubDependencyFactory {
        private final KotlinLibraryLibraryAccessors laccForKotlinLibraryLibraryAccessors = new KotlinLibraryLibraryAccessors(owner);

        public KotlinLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>kotlin.library</b>
         */
        public KotlinLibraryLibraryAccessors getLibrary() {
            return laccForKotlinLibraryLibraryAccessors;
        }

    }

    public static class KotlinLibraryLibraryAccessors extends SubDependencyFactory {

        public KotlinLibraryLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getBase() {
            return create("kotlin.library.base");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>libraryBase</b> with value <b>3.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
